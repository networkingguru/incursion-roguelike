...
| 7 | Serialise | `src/RComp.cpp:223` -> `src/Registry.cpp:1438` | `Module` -> `mod/Incursion.Mod` |
| 8 | Load | `src/Registry.cpp:1485` scans `mod/*.Mod` | file -> live `Module*` in `Modules[slot]` (`src/Registry.cpp:1515`) |
...
(`inc/Defines.h:45`, `inc/Defines.h:4697`).
