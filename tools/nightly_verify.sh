...
# The behavioural half of inc-m2zi and inc-w26h, plus inc-tos. These are listed
...
# the five together cost about three minutes rather than seconds. They are
...
LIVE_CHECKS=(
    ...
    "tools/check_dungeonmap_bounds.sh"
)
