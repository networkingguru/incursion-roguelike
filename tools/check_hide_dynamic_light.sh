...
out="$(INCURSION_LIGHT_PROBE=1 INCURSION_BIN="$BIN" INCURSION_OPTIONS=tools/fixtures/options-2026-08-22.dat tools/headless.sh tools/keys/hide-dynamic-light.keys 1 2>&1)"
status=$?
