...
# times its plus plus one (src/Item.cpp:2396, Level: PLUS_3PER1_ADD1). So the
...
out="$(INCURSION_OPTIONS=tools/fixtures/options-2026-08-22.dat tools/headless.sh tools/keys/wand-cleansing.keys "$SEED" 2>&1)"
