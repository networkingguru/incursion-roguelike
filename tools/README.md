...
| `check_enchant_graceful.sh` | Does the compiled Enchant Armour (graceful) scroll page advertise graceful while the featherlight scroll's page still advertises featherlight? | LIVE |
