...
| `check_enchant_graceful.sh` | Do the compiled Enchant Armour scroll pages advertise their own qualities and the Goblin Queen staff page its caster-level gate? |
