...
| `check_enchant_graceful.sh` | Does the compiled Enchant Armour (graceful) scroll page advertise graceful while its featherlight control still advertises featherlight? |
