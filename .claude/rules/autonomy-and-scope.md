...
On any commit/build/push anomaly (hook rejects, check fails, file lands wrong): do NOT dismiss it as "not mine". Investigate the root cause, report issue + evidence + blast radius, do NOT fix it unless asked, then STOP.
